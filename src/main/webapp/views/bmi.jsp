...
<html lang="en">
  <head>
    ...
    <title>BMI Calculator - Tools.com</title>
  ...
  >
    ...
    >
      <h1 class="text-4xl font-extrabold mb-2">BMI Calculator</h1>
      <p class="text-gray-200 text-lg">Calculate your Body Mass Index.</p>
    </header>
    ...
    <main class="flex-1 container mx-auto px-6 py-14">
      ...
      >
        <form class="space-y-6">
          ...
          <button
            class="w-full hover:brightness-110 transition-all px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium shadow-md transition"
          >
            Calculate
          </button>
        </form>
        ...
        <div class="mt-10">
          <a
            href="/"
            class="btn-animate w-full inline-block px-6 py-2 rounded-full bg-gray-700 text-white font-medium"
          >Back to Home
          </a>
        </div>
      </div>
