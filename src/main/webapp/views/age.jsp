...
<html lang="en">
  <head>
    ...
    <title>Age Calculator - Tools.com</title>
  ...
  >
    ...
    >
      <h1 class="text-4xl font-extrabold mb-2">Age Calculator</h1>
      <p class="text-gray-200 text-lg">Calculate your age from birthdate.</p>
    </header>
    ...
    <main class="flex-1 container mx-auto px-6 py-14">
      ...
      >
        <form class="space-y-6">
          ...
          <div>
            <label class="block text-gray-700 font-medium mb-2">Your Age</label>
            <input
              type="text"
              placeholder="Result"
              readonly
          ...
          <button
            class=" px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium shadow-md hover:brightness-110 transition-all"
          >
            Calculate
          </button>
        </form>
