...
<head>
  ...
  <style>
    ...
    .animate-page-enter { animation: page-enter 0.8s ease-out forwards; }

    .btn-animate:hover { @apply scale-105 shadow-lg transition; }
  </style>
</head>
<body class="bg-gradient-to-br from-purple-200 via-pink-100 to-indigo-200 min-h-screen flex flex-col items-center opacity-0 animate-page-enter">

  <!-- Header -->
  <header class="rounded-b-xl text-center py-12 w-full bg-gradient-to-r from-purple-600 via-indigo-600 to-pink-600 shadow-lg text-white">
    <h1 class="text-4xl md:text-5xl font-extrabold mb-2">Calculator</h1>
    <p class="text-gray-200 text-lg md:text-xl">Perform simple arithmetic operations</p>
  </header>

  <!-- Right Panel Calculator -->
  <main class="flex-1 flex justify-center items-center w-full px-4 py-12">
    <div class="bg-white/50 backdrop-blur-md shadow-2xl rounded-3xl p-8 max-w-sm w-full transform transition hover:scale-105">

      <form action="CalculatorServlet" method="post" class="space-y-4">
  ...
  <!-- Footer -->
  <footer class="rounded-t-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white w-full text-center py-6 bg-gray-900 text-gray-400 text-sm">
